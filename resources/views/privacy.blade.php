    ...
    <section class="bg-gradient-to-b from-green-50 to-white py-20">
        <div class="max-w-6xl mx-auto px-5">
            <div class="text-center mb-12">
                <span
                    class="inline-flex items-center gap-2 bg-green-100 text-green-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">Vos données, notre priorité</span>
                <h1 class="font-display text-5xl font-extrabold text-gray-900 mb-4">Politique <span
                        class="text-green-500">de confidentialité</span></h1>
